...
public class VierGewinntAlt {
        ...
        public VierGewinntAlt(InputStream in, PrintStream out) {
                VierGewinntAlt.input = new Scanner(in);
                VierGewinntAlt.output = out;
                winner = null;
        }
        ...
        public void play() {
                ...
                while (zaehler < columns*rows && winner == null) {
                        ...
                        if (eingabe > columns || eingabe < 1)
                                output.println("Feld existriert nicht.. Bitte versuch es nochmal!");
                        else {
        ...
        static Character setzeFeld(char[][] spielfeld, int column, char zeichen) {
                ...
                if (spielfeld[0][column] != '\0'){
                        output.println("Die Reihe ist voll.. Pech!");
                        return null;
                }
